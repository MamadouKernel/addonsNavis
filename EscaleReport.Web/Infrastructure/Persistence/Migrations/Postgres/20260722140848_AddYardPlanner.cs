        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Priorite = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    Responsable = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    DatePrevue = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DateRealisation = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Bay = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    NombreConteneurs = table.Column<int>(type: "integer", nullable: false),
                    DetailOuDestination = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceMaritime = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    ZoneDebarquement = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ReefersImport = table.Column<int>(type: "integer", nullable: false),
                    ReefersExport = table.Column<int>(type: "integer", nullable: false),
                    ConteneursTransbordement = table.Column<int>(type: "integer", nullable: false),
