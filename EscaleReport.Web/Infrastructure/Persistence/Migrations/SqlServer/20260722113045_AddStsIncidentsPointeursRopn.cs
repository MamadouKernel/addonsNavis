        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DifficulteRencontree = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GantryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    TypeIncident = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    ConditionsReprise = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    RetirePortiqueEffectif = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nom = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Role = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    NavireOuZone = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    HeurePriseDePosteUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    HeureFinUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Remarque = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
