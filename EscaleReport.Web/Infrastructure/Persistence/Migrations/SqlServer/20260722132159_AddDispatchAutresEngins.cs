        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisponibleReachStackers = table.Column<int>(type: "int", nullable: false),
                    DisponibleEmptyHandlers = table.Column<int>(type: "int", nullable: false),
                    DisponibleAutres = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Probleme = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Operateur = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    EnginQuitte = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    NouvelEngin = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    DateHeureUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
