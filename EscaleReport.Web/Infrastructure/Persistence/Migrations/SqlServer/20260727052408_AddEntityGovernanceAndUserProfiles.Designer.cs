...
namespace EscaleReport.Web.Infrastructure.Persistence.Migrations.SqlServer
{
    ...
    [Migration("20260727052408_AddEntityGovernanceAndUserProfiles")]
    partial class AddEntityGovernanceAndUserProfiles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EscaleReport.Web.Domain.Dispatch.TtDeconnexion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EscaleReport.Web.Domain.Reporting.ShiftHandoverNote", b =>
                {
                    ...
                    b.HasIndex("Date", "Shift")
                        .IsUnique()
                        .HasFilter("[Shift] IS NOT NULL");

                    b.ToTable("ShiftHandoverNotes");
                });

            modelBuilder.Entity("EscaleReport.Web.Domain.Settings.AlertThreshold", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EscaleReport.Web.Domain.Settings.GeneralSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("PlanificateurParDefaut")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
